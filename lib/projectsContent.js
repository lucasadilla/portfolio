/** Slug → project page content for `/projects/[slug]` */
export const PROJECT_REGISTRY = {
    ...
    debate: {
        ...
        images: [
            { src: '/images/bick1.png', text: 'Write down a controversial opinion in under 200 characters.' },
            { src: '/images/bick2.png', text: 'Respond to an opinion you disagree with in under 200 characters.' },
            { src: '/images/bick3.png', text: 'Vote on others\' disagreements and decide the winner.' },
            { src: '/images/bick4.png', text: 'View other debates and their vote counts.' },
    ...
    udem: {
        ...
        /** Bump this string when you replace screenshots but keep the same filenames (fd1.png, …). */
        imageCacheBust: '3',
        intro: {
...
export const PROJECT_SLUGS = ['bitpass', 'raz', 'portfolio', 'debate', 'udem', 'portify'];
